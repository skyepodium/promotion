const SUPPORTED_LANGUAGES = ['ko', 'en', 'ja', 'zh', 'zh-TW', 'vi', 'es', 'fr', 'de', 'pt', 'id', 'it', 'th', 'ar', 'ru', 'tr'];
...
const TRANSLATIONS = {
  ko: {
    ...
    'kurotty.download.note':
      '최신 알파 릴리즈. Intel 및 Apple Silicon Mac용 Universal DMG. macOS 14 이상 권장.',
...
const PRIVACY_TRANSLATIONS = {
  ...
  tr: {
    ...
    'common.privacyLong': 'Gizlilik Politikası',
    'privacy.meta.description':
      'Kitsnyang kişisel bilgileri toplamaz veya izlemez. Alarm ayarları ve kurtarma durumu cihazınızda kalır.',
    'privacy.meta.title': 'Kitsnyang Gizlilik Politikası',
    'privacy.hero.eyebrow': 'Gizlilik Politikası',
    'privacy.hero.title': 'Kitsnyang kişisel bilgi toplamaz.',
    'privacy.hero.lead': 'Alarm saati, tekrar günleri, alarm sesleri ve kurtarma durumu cihazınızda kalır.',
    'privacy.summary.aria': 'Gizlilik özeti',
    'privacy.summary.collect.title': 'Veri toplama yok',
    'privacy.summary.collect.body': 'Ad, e-posta, konum, kişiler veya cihaz kimliği toplamıyoruz.',
    'privacy.summary.local.title': 'Cihazda saklanır',
    'privacy.summary.local.body': 'Alarm ayarları harici sunuculara gönderilmez.',
    'privacy.summary.thirdParty.title': 'Takip aracı yok',
    'privacy.summary.thirdParty.body': 'Reklam SDK’ları, analiz SDK’ları veya üçüncü taraf takip araçları kullanmıyoruz.',
    'privacy.policy.title': 'Kitsnyang Gizlilik Politikası',
    'privacy.collection.title': 'Toplanan kişisel bilgiler',
    'privacy.collection.body':
      'Kitsnyang ad, e-posta, konum, kişiler veya cihaz tanımlayıcıları gibi sizi tanımlayabilecek bilgileri toplamaz.',
    'privacy.local.title': 'Cihazınızda saklanan veriler',
    'privacy.local.body':
      'Kitsnyang alarmları sağlamak ve uygulamayı güvenilir biçimde kurtarmak için aşağıdaki verileri cihazınızda saklayabilir.',
    'privacy.local.item.alarm': 'Alarm saati, tekrar günleri, ses, renk ve açık/kapalı durumu',
    'privacy.local.item.preference': 'Tema ve uygulama görünümü gibi kullanıcının seçtiği ayarlar',
    'privacy.local.item.recovery': 'Alarmın çalması, kapatılması ve yeniden başlatma sonrası kurtarma için yerel durum kayıtları',
    'privacy.permissions.title': 'İzinler nasıl kullanılır',
    'privacy.permissions.body': 'Kitsnyang tarafından istenen izinler yalnızca alarmları planlamak ve çaldırmak için kullanılır.',
    'privacy.permissions.item.notification': 'Bildirimler: ayarladığınız saatte alarmı göstermek ve çaldırmak için kullanılır.',
    'privacy.permissions.item.alarm':
      'Kesin alarmlar: cihaz kilitliyken veya güç tasarrufundayken alarmın planlanan saatte çalması için kullanılır.',
    'privacy.permissions.item.sound': 'Ses ve titreşim: seçtiğiniz alarm sesi ve titreşimle sizi uyarmak için kullanılır.',
    'privacy.sharing.title': 'Harici aktarım ve üçüncü taraf paylaşımı',
    'privacy.sharing.body': 'Kitsnyang saklanan verileri harici sunuculara göndermez ve üçüncü taraflarla paylaşmaz.',
    'privacy.ads.title': 'Reklamlar ve analiz',
    'privacy.ads.body': 'Kitsnyang reklam SDK’ları, analiz SDK’ları veya üçüncü taraf takip araçları kullanmaz.',
    'privacy.delete.title': 'Verileri silme',
    'privacy.delete.body': 'Cihazınızda saklanan veriler uygulamayı sildiğinizde silinir.',
    'privacy.retention.title': 'Saklama süresi',
    'privacy.retention.body': 'Cihazınızda saklanan veriler, alarm verilerini veya uygulamayı silene kadar cihazda kalır.',
    'privacy.children.title': 'Çocukların gizliliği',
    'privacy.children.body': 'Kitsnyang çocuklar dahil hiçbir kullanıcıdan bilerek kişisel bilgi toplamaz.',
    'privacy.changes.title': 'Bu politikadaki değişiklikler',
    'privacy.changes.body':
      'Kitsnyang’ın veri işleme uygulamaları değişirse bu sayfanın yürürlük tarihini ve içeriğini güncelleriz.',
    'privacy.contact.title': 'İletişim',
    'privacy.contact.body': 'Bu Gizlilik Politikası ile ilgili sorularınız için lütfen bize e-posta gönderin.',
    'privacy.updated': 'Yürürlük tarihi: 7 Haziran 2026',
    'privacy.backCta': 'Kitsnyang’a geri dön',
  },
};

const SITE_TRANSLATION_OVERRIDES = {
  de: {
    'home.meta.description': 'Eine statische Promotionsseite für Projekte und Services von skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Kleine Services, klare Interaktionen.',
    'home.hero.title': 'Klein gebaut,<br />auf Dauer verfeinert.',
    'home.hero.lead':
      'Ich entwickle und poliere Apps, Tools und kleine digitale Spielereien. Aktuell arbeite ich an <a href="./kitsnyang.html">Kitsnyang</a>, einer Morgenwecker-App.',
    'home.hero.cta': 'Kitsnyang ansehen',
    'home.actions.aria': 'Ausgewählte Arbeiten',
    'home.project.body': 'Kostenlos, werbefrei, mit mehreren Wecktönen. Ein Wecker, der Morgen etwas leichter macht.',
    'home.project.linkAria': 'Zur Kitsnyang-Seite wechseln',
    'kitsnyang.meta.description':
      'Kitsnyang ist ein kostenloser, werbefreier Morgenwecker mit mehreren Wecktönen und einer spielerischen Einrichtung.',
    'kitsnyang.meta.title': 'Kitsnyang - ein sanfterer Morgenwecker',
    'kitsnyang.hero.eyebrow': 'Kostenlose Wecker-App / keine Werbung',
    'kitsnyang.hero.line': 'Ein Morgenwecker, der das Aufstehen etwas leichter macht.',
    'kitsnyang.proof.aria': 'Wichtige Kitsnyang-Funktionen',
    'kitsnyang.proof.free': 'Kostenlos',
    'kitsnyang.proof.noAds': 'Keine Werbung',
    'kitsnyang.proof.sounds': 'Viele Töne',
    'kitsnyang.heroStage.aria': 'Vorschau der Kitsnyang-App-Bildschirme',
    'kitsnyang.icon.alt': 'Kitsnyang App-Icon',
    'kitsnyang.phone.list.aria': 'Beispiel für die Weckerliste',
    'kitsnyang.phone.sound.aria': 'Beispiel für die Ton-Auswahl',
    'kitsnyang.alarm.daily': 'Täglich',
    'kitsnyang.alarm.weekdays': 'Werktage',
    'kitsnyang.alarm.weekend': 'Wochenende',
    'kitsnyang.sound.label': 'Weckton',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'Blaue Meeresbrise',
    'kitsnyang.statement.eyebrow': 'Ohne Lärm',
    'kitsnyang.statement.title': 'Nur das, was du brauchst.',
    'kitsnyang.statement.free': 'Kostenlos',
    'kitsnyang.statement.noAds': 'Keine Werbung',
    'kitsnyang.statement.music': 'Mehrere Tracks',
    'kitsnyang.statement.morning': 'Für Morgen gemacht',
    'kitsnyang.showcase.eyebrow': 'Vier Bildschirme',
    'kitsnyang.showcase.title': 'Vier Bildschirme reichen.',
    'kitsnyang.showcase.body': 'Zeit wählen, Farbe wählen, Ton wählen und morgens ausschalten.',
    'kitsnyang.showcase.aria': 'Vier Hauptbildschirme von Kitsnyang',
    'kitsnyang.screen.list.title': 'Weckerliste',
    'kitsnyang.screen.list.body': 'Nur aktive Wecker fallen klar auf.',
    'kitsnyang.screen.time.title': 'Zeit einstellen',
    'kitsnyang.screen.time.body': 'Das Rad bleibt leicht und präzise.',
    'kitsnyang.screen.sound.title': 'Wecktöne',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Alarm ausschalten',
    'kitsnyang.screen.dismiss.action': 'Aus',
    'kitsnyang.screen.dismiss.body': 'Beim Aufwachen sofort verständlich.',
    'kitsnyang.sounds.eyebrow': 'Wecktöne',
    'kitsnyang.sounds.title': 'Für jede Stimmung ein anderer Morgen.',
    'kitsnyang.sounds.body': 'Höre die ersten Tracks in derselben Reihenfolge wie in der App kurz an.',
    'kitsnyang.sounds.aria': 'Player für ausgewählte Wecktöne',
    'kitsnyang.player.eyebrow': 'Jetzt reinhören',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Sanft aufwachen',
    'kitsnyang.closing.title': 'Auch Aufwachen<br />darf ein bisschen niedlich sein.',
    'kitsnyang.closing.body': 'Kitsnyang ist kostenlos, werbefrei und lässt dich Töne für den Morgen auswählen.',
  },
  pt: {
    'home.meta.description': 'Um site promocional estático para projetos e serviços da skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Serviços pequenos, interações nítidas.',
    'home.hero.title': 'Pequeno no começo,<br />lapidado para durar.',
    'home.hero.lead':
      'Crio e aperfeiçoo apps, ferramentas e pequenos brinquedos digitais. Agora estou moldando <a href="./kitsnyang.html">Kitsnyang</a>, um app de despertador matinal.',
    'home.hero.cta': 'Ver Kitsnyang',
    'home.actions.aria': 'Trabalhos em destaque',
    'home.project.body': 'Grátis, sem anúncios, com vários sons. Um despertador que deixa a manhã um pouco mais leve.',
    'home.project.linkAria': 'Ir para a página do Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang é um despertador matinal gratuito, sem anúncios, com vários sons e uma configuração divertida.',
    'kitsnyang.meta.title': 'Kitsnyang - um despertador matinal mais leve',
    'kitsnyang.hero.eyebrow': 'App de despertador grátis / sem anúncios',
    'kitsnyang.hero.line': 'Um despertador matinal que torna acordar um pouco mais fácil.',
    'kitsnyang.proof.aria': 'Principais recursos do Kitsnyang',
    'kitsnyang.proof.free': 'Grátis',
    'kitsnyang.proof.noAds': 'Sem anúncios',
    'kitsnyang.proof.sounds': 'Muitos sons',
    'kitsnyang.heroStage.aria': 'Prévia das telas do app Kitsnyang',
    'kitsnyang.icon.alt': 'Ícone do app Kitsnyang',
    'kitsnyang.phone.list.aria': 'Exemplo de tela da lista de alarmes',
    'kitsnyang.phone.sound.aria': 'Exemplo de tela de escolha de som',
    'kitsnyang.alarm.daily': 'Diário',
    'kitsnyang.alarm.weekdays': 'Dias úteis',
    'kitsnyang.alarm.weekend': 'Fim de semana',
    'kitsnyang.sound.label': 'Som do alarme',
    'kitsnyang.sound.featured': 'Brisa de Geoje',
    'kitsnyang.sound.caption': 'Brisa azul do mar',
    'kitsnyang.statement.eyebrow': 'Sem ruído',
    'kitsnyang.statement.title': 'Só o que você precisa.',
    'kitsnyang.statement.free': 'Grátis',
    'kitsnyang.statement.noAds': 'Sem anúncios',
    'kitsnyang.statement.music': 'Várias faixas',
    'kitsnyang.statement.morning': 'Feito para manhãs',
    'kitsnyang.showcase.eyebrow': 'Quatro telas',
    'kitsnyang.showcase.title': 'Quatro telas bastam.',
    'kitsnyang.showcase.body': 'Escolha o horário, a cor, o som e desligue pela manhã.',
    'kitsnyang.showcase.aria': 'Quatro telas principais do Kitsnyang',
    'kitsnyang.screen.list.title': 'Lista de alarmes',
    'kitsnyang.screen.list.body': 'Só os alarmes ativos se destacam.',
    'kitsnyang.screen.time.title': 'Definir horário',
    'kitsnyang.screen.time.body': 'A roda é leve e precisa.',
    'kitsnyang.screen.sound.title': 'Sons de alarme',
    'kitsnyang.sound.geoje': 'Brisa de Geoje',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Desligar alarme',
    'kitsnyang.screen.dismiss.action': 'Desligar',
    'kitsnyang.screen.dismiss.body': 'Claro à primeira vista quando você acorda.',
    'kitsnyang.sounds.eyebrow': 'Sons',
    'kitsnyang.sounds.title': 'Uma manhã diferente para cada humor.',
    'kitsnyang.sounds.body': 'Ouça as primeiras faixas na mesma ordem do app.',
    'kitsnyang.sounds.aria': 'Player de sons de alarme em destaque',
    'kitsnyang.player.eyebrow': 'Prévia agora',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Acordar com leveza',
    'kitsnyang.closing.title': 'Até acordar<br />pode ser um pouco fofo.',
    'kitsnyang.closing.body': 'Kitsnyang é grátis, sem anúncios, e deixa você escolher sons feitos para a manhã.',
  },
  id: {
    'home.meta.description': 'Situs promosi statis untuk proyek dan layanan skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Layanan kecil, interaksi jelas.',
    'home.hero.title': 'Dibuat kecil,<br />dipoles agar tahan lama.',
    'home.hero.lead':
      'Saya membuat dan merapikan app, alat, dan mainan digital kecil. Saat ini saya sedang membentuk <a href="./kitsnyang.html">Kitsnyang</a>, app alarm pagi.',
    'home.hero.cta': 'Lihat Kitsnyang',
    'home.actions.aria': 'Karya pilihan',
    'home.project.body': 'Gratis, tanpa iklan, dengan banyak suara alarm. Alarm yang membuat pagi sedikit lebih ringan.',
    'home.project.linkAria': 'Buka halaman Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang adalah app alarm pagi gratis tanpa iklan, dengan banyak suara alarm dan layar pengaturan yang menyenangkan.',
    'kitsnyang.meta.title': 'Kitsnyang - alarm pagi yang lebih ringan',
    'kitsnyang.hero.eyebrow': 'App alarm gratis / tanpa iklan',
    'kitsnyang.hero.line': 'Alarm pagi yang membuat bangun tidur sedikit lebih mudah.',
    'kitsnyang.proof.aria': 'Fitur utama Kitsnyang',
    'kitsnyang.proof.free': 'Gratis',
    'kitsnyang.proof.noAds': 'Tanpa iklan',
    'kitsnyang.proof.sounds': 'Banyak suara',
    'kitsnyang.heroStage.aria': 'Pratinjau layar app Kitsnyang',
    'kitsnyang.icon.alt': 'Ikon app Kitsnyang',
    'kitsnyang.phone.list.aria': 'Contoh layar daftar alarm',
    'kitsnyang.phone.sound.aria': 'Contoh layar pilihan suara alarm',
    'kitsnyang.alarm.daily': 'Setiap hari',
    'kitsnyang.alarm.weekdays': 'Hari kerja',
    'kitsnyang.alarm.weekend': 'Akhir pekan',
    'kitsnyang.sound.label': 'Suara alarm',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'Angin laut biru',
    'kitsnyang.statement.eyebrow': 'Tanpa bising',
    'kitsnyang.statement.title': 'Hanya yang Anda perlukan.',
    'kitsnyang.statement.free': 'Gratis',
    'kitsnyang.statement.noAds': 'Tanpa iklan',
    'kitsnyang.statement.music': 'Beberapa trek',
    'kitsnyang.statement.morning': 'Dibuat untuk pagi',
    'kitsnyang.showcase.eyebrow': 'Empat layar',
    'kitsnyang.showcase.title': 'Empat layar sudah cukup.',
    'kitsnyang.showcase.body': 'Pilih waktu, pilih warna, pilih suara, lalu matikan saat pagi.',
    'kitsnyang.showcase.aria': 'Empat layar utama Kitsnyang',
    'kitsnyang.screen.list.title': 'Daftar alarm',
    'kitsnyang.screen.list.body': 'Hanya alarm aktif yang menonjol.',
    'kitsnyang.screen.time.title': 'Atur waktu',
    'kitsnyang.screen.time.body': 'Roda tetap ringan dan presisi.',
    'kitsnyang.screen.sound.title': 'Suara alarm',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Matikan alarm',
    'kitsnyang.screen.dismiss.action': 'Matikan',
    'kitsnyang.screen.dismiss.body': 'Jelas terlihat saat Anda bangun.',
    'kitsnyang.sounds.eyebrow': 'Suara alarm',
    'kitsnyang.sounds.title': 'Pagi berbeda untuk setiap suasana.',
    'kitsnyang.sounds.body': 'Dengarkan pratinjau trek pertama dalam urutan yang sama seperti app.',
    'kitsnyang.sounds.aria': 'Pemutar suara alarm pilihan',
    'kitsnyang.player.eyebrow': 'Sedang dipratinjau',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Bangun dengan lembut',
    'kitsnyang.closing.title': 'Bangun tidur pun<br />bisa terasa sedikit lucu.',
    'kitsnyang.closing.body': 'Kitsnyang gratis, tanpa iklan, dan membantu Anda memilih suara untuk pagi hari.',
  },
  it: {
    'home.meta.description': 'Un sito promozionale statico per i progetti e i servizi di skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Piccoli servizi, interazioni nitide.',
    'home.hero.title': 'Piccolo da creare,<br />curato per durare.',
    'home.hero.lead':
      'Creo e rifinisco app, strumenti e piccoli giocattoli digitali. Ora sto dando forma a <a href="./kitsnyang.html">Kitsnyang</a>, un’app sveglia per il mattino.',
    'home.hero.cta': 'Vedi Kitsnyang',
    'home.actions.aria': 'Lavori in evidenza',
    'home.project.body': 'Gratis, senza pubblicità, con tanti suoni. Una sveglia che rende il mattino un po’ più leggero.',
    'home.project.linkAria': 'Vai alla pagina di Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang è un’app sveglia gratuita e senza pubblicità, con più suoni e una schermata di configurazione giocosa.',
    'kitsnyang.meta.title': 'Kitsnyang - una sveglia mattutina più gentile',
    'kitsnyang.hero.eyebrow': 'App sveglia gratuita / senza pubblicità',
    'kitsnyang.hero.line': 'Una sveglia mattutina che rende il risveglio un po’ più facile.',
    'kitsnyang.proof.aria': 'Funzioni principali di Kitsnyang',
    'kitsnyang.proof.free': 'Gratis',
    'kitsnyang.proof.noAds': 'Senza pubblicità',
    'kitsnyang.proof.sounds': 'Molti suoni',
    'kitsnyang.heroStage.aria': 'Anteprima delle schermate dell’app Kitsnyang',
    'kitsnyang.icon.alt': 'Icona dell’app Kitsnyang',
    'kitsnyang.phone.list.aria': 'Esempio di schermata elenco sveglie',
    'kitsnyang.phone.sound.aria': 'Esempio di schermata scelta suono',
    'kitsnyang.alarm.daily': 'Ogni giorno',
    'kitsnyang.alarm.weekdays': 'Giorni feriali',
    'kitsnyang.alarm.weekend': 'Weekend',
    'kitsnyang.sound.label': 'Suono sveglia',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'Brezza marina blu',
    'kitsnyang.statement.eyebrow': 'Senza rumore',
    'kitsnyang.statement.title': 'Solo quello che serve.',
    'kitsnyang.statement.free': 'Gratis',
    'kitsnyang.statement.noAds': 'Senza pubblicità',
    'kitsnyang.statement.music': 'Più brani',
    'kitsnyang.statement.morning': 'Pensata per il mattino',
    'kitsnyang.showcase.eyebrow': 'Quattro schermate',
    'kitsnyang.showcase.title': 'Quattro schermate bastano.',
    'kitsnyang.showcase.body': 'Scegli l’orario, il colore, il suono e spegni al mattino.',
    'kitsnyang.showcase.aria': 'Quattro schermate principali di Kitsnyang',
    'kitsnyang.screen.list.title': 'Elenco sveglie',
    'kitsnyang.screen.list.body': 'Solo le sveglie attive risaltano.',
    'kitsnyang.screen.time.title': 'Imposta ora',
    'kitsnyang.screen.time.body': 'La rotella resta leggera e precisa.',
    'kitsnyang.screen.sound.title': 'Suoni sveglia',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Disattiva sveglia',
    'kitsnyang.screen.dismiss.action': 'Disattiva',
    'kitsnyang.screen.dismiss.body': 'Chiara appena ti svegli.',
    'kitsnyang.sounds.eyebrow': 'Suoni',
    'kitsnyang.sounds.title': 'Un mattino diverso per ogni umore.',
    'kitsnyang.sounds.body': 'Ascolta in anteprima i primi brani nello stesso ordine dell’app.',
    'kitsnyang.sounds.aria': 'Player dei suoni sveglia in evidenza',
    'kitsnyang.player.eyebrow': 'Anteprima ora',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Svegliarsi con dolcezza',
    'kitsnyang.closing.title': 'Anche svegliarsi<br />può essere un po’ carino.',
    'kitsnyang.closing.body': 'Kitsnyang è gratuita, senza pubblicità, e ti fa scegliere suoni pensati per il mattino.',
  },
  th: {
    'home.meta.description': 'เว็บไซต์โปรโมตแบบสแตติกสำหรับโปรเจกต์และบริการของ skyepodium',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'บริการเล็ก ๆ ปฏิสัมพันธ์คมชัด',
    'home.hero.title': 'สร้างให้เล็ก<br />ขัดเกลาให้ใช้นาน',
    'home.hero.lead':
      'ฉันสร้างและปรับแต่งแอป เครื่องมือ และของเล่นดิจิทัลเล็ก ๆ ตอนนี้กำลังดูแล <a href="./kitsnyang.html">Kitsnyang</a> แอปนาฬิกาปลุกยามเช้า',
    'home.hero.cta': 'ดู Kitsnyang',
    'home.actions.aria': 'ผลงานเด่น',
    'home.project.body': 'ฟรี ไม่มีโฆษณา มีเสียงปลุกหลายแบบ นาฬิกาปลุกที่ทำให้เช้าง่ายขึ้นนิดหน่อย',
    'home.project.linkAria': 'ไปยังหน้าของ Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang เป็นแอปนาฬิกาปลุกตอนเช้าฟรี ไม่มีโฆษณา มีเสียงปลุกหลายแบบและหน้าตั้งค่าที่สนุก',
    'kitsnyang.meta.title': 'Kitsnyang - นาฬิกาปลุกตอนเช้าที่อ่อนโยนขึ้น',
    'kitsnyang.hero.eyebrow': 'แอปนาฬิกาปลุกฟรี / ไม่มีโฆษณา',
    'kitsnyang.hero.line': 'นาฬิกาปลุกตอนเช้าที่ทำให้การตื่นง่ายขึ้นนิดหน่อย',
    'kitsnyang.proof.aria': 'คุณสมบัติหลักของ Kitsnyang',
    'kitsnyang.proof.free': 'ฟรี',
    'kitsnyang.proof.noAds': 'ไม่มีโฆษณา',
    'kitsnyang.proof.sounds': 'หลายเสียง',
    'kitsnyang.heroStage.aria': 'ตัวอย่างหน้าจอแอป Kitsnyang',
    'kitsnyang.icon.alt': 'ไอคอนแอป Kitsnyang',
    'kitsnyang.phone.list.aria': 'ตัวอย่างหน้าจอรายการปลุก',
    'kitsnyang.phone.sound.aria': 'ตัวอย่างหน้าจอเลือกเสียงปลุก',
    'kitsnyang.alarm.daily': 'ทุกวัน',
    'kitsnyang.alarm.weekdays': 'วันธรรมดา',
    'kitsnyang.alarm.weekend': 'สุดสัปดาห์',
    'kitsnyang.sound.label': 'เสียงปลุก',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'สายลมทะเลสีฟ้า',
    'kitsnyang.statement.eyebrow': 'ไม่มีเสียงรบกวน',
    'kitsnyang.statement.title': 'เหลือไว้แค่สิ่งที่จำเป็น',
    'kitsnyang.statement.free': 'ฟรี',
    'kitsnyang.statement.noAds': 'ไม่มีโฆษณา',
    'kitsnyang.statement.music': 'หลายแทร็ก',
    'kitsnyang.statement.morning': 'สร้างมาเพื่อยามเช้า',
    'kitsnyang.showcase.eyebrow': 'สี่หน้าจอ',
    'kitsnyang.showcase.title': 'สี่หน้าจอก็เพียงพอ',
    'kitsnyang.showcase.body': 'เลือกเวลา เลือกสี เลือกเสียง แล้วปิดเมื่อถึงตอนเช้า',
    'kitsnyang.showcase.aria': 'สี่หน้าจอหลักของ Kitsnyang',
    'kitsnyang.screen.list.title': 'รายการปลุก',
    'kitsnyang.screen.list.body': 'ให้เฉพาะปลุกที่เปิดอยู่เด่นชัด',
    'kitsnyang.screen.time.title': 'ตั้งเวลา',
    'kitsnyang.screen.time.body': 'วงล้อเบาและแม่นยำ',
    'kitsnyang.screen.sound.title': 'เสียงปลุก',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'ปิดปลุก',
    'kitsnyang.screen.dismiss.action': 'ปิด',
    'kitsnyang.screen.dismiss.body': 'เข้าใจได้ทันทีเมื่อตื่น',
    'kitsnyang.sounds.eyebrow': 'เสียงปลุก',
    'kitsnyang.sounds.title': 'เช้าที่ต่างกันตามอารมณ์',
    'kitsnyang.sounds.body': 'ลองฟังแทร็กแรก ๆ ตามลำดับเดียวกับในแอป',
    'kitsnyang.sounds.aria': 'เครื่องเล่นเสียงปลุกเด่น',
    'kitsnyang.player.eyebrow': 'กำลังพรีวิว',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'ตื่นอย่างนุ่มนวล',
    'kitsnyang.closing.title': 'แม้แต่การตื่น<br />ก็อาจน่ารักขึ้นได้',
    'kitsnyang.closing.body': 'Kitsnyang ฟรี ไม่มีโฆษณา และให้คุณเลือกเสียงที่สร้างมาเพื่อยามเช้า',
  },
  ar: {
    'home.meta.description': 'موقع ترويجي ثابت لمشاريع وخدمات skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'خدمات صغيرة وتفاعلات واضحة.',
    'home.hero.title': 'نبني صغيرا،<br />ونصقل ليبقى طويلا.',
    'home.hero.lead':
      'أصنع وأصقل التطبيقات والأدوات والألعاب الرقمية الصغيرة. أعمل الآن على <a href="./kitsnyang.html">Kitsnyang</a>، تطبيق منبه صباحي.',
    'home.hero.cta': 'عرض Kitsnyang',
    'home.actions.aria': 'أعمال مختارة',
    'home.project.body': 'مجاني، بلا إعلانات، مع عدة أصوات منبه. منبه يجعل الصباح أسهل قليلا.',
    'home.project.linkAria': 'الانتقال إلى صفحة Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang تطبيق منبه صباحي مجاني بلا إعلانات، يقدم عدة أصوات منبه وتجربة إعداد مرحة.',
    'kitsnyang.meta.title': 'Kitsnyang - منبه صباحي ألطف',
    'kitsnyang.hero.eyebrow': 'تطبيق منبه مجاني / بلا إعلانات',
    'kitsnyang.hero.line': 'منبه صباحي يجعل الاستيقاظ أسهل قليلا.',
    'kitsnyang.proof.aria': 'ميزات Kitsnyang الرئيسية',
    'kitsnyang.proof.free': 'مجاني',
    'kitsnyang.proof.noAds': 'بلا إعلانات',
    'kitsnyang.proof.sounds': 'أصوات متعددة',
    'kitsnyang.heroStage.aria': 'معاينة شاشات تطبيق Kitsnyang',
    'kitsnyang.icon.alt': 'أيقونة تطبيق Kitsnyang',
    'kitsnyang.phone.list.aria': 'مثال لشاشة قائمة المنبهات',
    'kitsnyang.phone.sound.aria': 'مثال لشاشة اختيار صوت المنبه',
    'kitsnyang.alarm.daily': 'يوميا',
    'kitsnyang.alarm.weekdays': 'أيام العمل',
    'kitsnyang.alarm.weekend': 'نهاية الأسبوع',
    'kitsnyang.sound.label': 'صوت المنبه',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'نسيم بحر أزرق',
    'kitsnyang.statement.eyebrow': 'بدون ضجيج',
    'kitsnyang.statement.title': 'فقط ما تحتاجه.',
    'kitsnyang.statement.free': 'مجاني',
    'kitsnyang.statement.noAds': 'بلا إعلانات',
    'kitsnyang.statement.music': 'عدة مقاطع',
    'kitsnyang.statement.morning': 'مصمم للصباح',
    'kitsnyang.showcase.eyebrow': 'أربع شاشات',
    'kitsnyang.showcase.title': 'أربع شاشات تكفي.',
    'kitsnyang.showcase.body': 'اختر الوقت واللون والصوت، ثم أوقفه في الصباح.',
    'kitsnyang.showcase.aria': 'أربع شاشات رئيسية من Kitsnyang',
    'kitsnyang.screen.list.title': 'قائمة المنبهات',
    'kitsnyang.screen.list.body': 'المنبهات النشطة تظهر بوضوح فقط.',
    'kitsnyang.screen.time.title': 'ضبط الوقت',
    'kitsnyang.screen.time.body': 'العجلة خفيفة ودقيقة.',
    'kitsnyang.screen.sound.title': 'أصوات المنبه',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'إيقاف المنبه',
    'kitsnyang.screen.dismiss.action': 'إيقاف',
    'kitsnyang.screen.dismiss.body': 'واضح من النظرة الأولى عند الاستيقاظ.',
    'kitsnyang.sounds.eyebrow': 'أصوات المنبه',
    'kitsnyang.sounds.title': 'صباح مختلف لكل مزاج.',
    'kitsnyang.sounds.body': 'استمع إلى المقاطع الأولى بنفس ترتيب التطبيق.',
    'kitsnyang.sounds.aria': 'مشغل أصوات المنبه المختارة',
    'kitsnyang.player.eyebrow': 'معاينة الآن',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'استيقاظ ناعم',
    'kitsnyang.closing.title': 'حتى الاستيقاظ<br />يمكن أن يكون لطيفا قليلا.',
    'kitsnyang.closing.body': 'Kitsnyang مجاني، بلا إعلانات، ويتيح لك اختيار أصوات مصممة للصباح.',
  },
  ru: {
    'home.meta.description': 'Статический промосайт для проектов и сервисов skyepodium.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Небольшие сервисы, четкие взаимодействия.',
    'home.hero.title': 'Делаем небольшим,<br />доводим до долговечности.',
    'home.hero.lead':
      'Я создаю и полирую приложения, инструменты и небольшие цифровые игрушки. Сейчас работаю над <a href="./kitsnyang.html">Kitsnyang</a>, утренним будильником.',
    'home.hero.cta': 'Открыть Kitsnyang',
    'home.actions.aria': 'Избранные работы',
    'home.project.body': 'Бесплатно, без рекламы, с несколькими звуками. Будильник, который делает утро немного легче.',
    'home.project.linkAria': 'Перейти на страницу Kitsnyang',
    'kitsnyang.meta.description':
      'Kitsnyang - бесплатный утренний будильник без рекламы, с несколькими звуками и простой игровой настройкой.',
    'kitsnyang.meta.title': 'Kitsnyang - более мягкий утренний будильник',
    'kitsnyang.hero.eyebrow': 'Бесплатный будильник / без рекламы',
    'kitsnyang.hero.line': 'Утренний будильник, с которым просыпаться немного легче.',
    'kitsnyang.proof.aria': 'Ключевые возможности Kitsnyang',
    'kitsnyang.proof.free': 'Бесплатно',
    'kitsnyang.proof.noAds': 'Без рекламы',
    'kitsnyang.proof.sounds': 'Много звуков',
    'kitsnyang.heroStage.aria': 'Предпросмотр экранов приложения Kitsnyang',
    'kitsnyang.icon.alt': 'Иконка приложения Kitsnyang',
    'kitsnyang.phone.list.aria': 'Пример экрана списка будильников',
    'kitsnyang.phone.sound.aria': 'Пример экрана выбора звука',
    'kitsnyang.alarm.daily': 'Ежедневно',
    'kitsnyang.alarm.weekdays': 'Будни',
    'kitsnyang.alarm.weekend': 'Выходные',
    'kitsnyang.sound.label': 'Звук будильника',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'Синий морской бриз',
    'kitsnyang.statement.eyebrow': 'Без шума',
    'kitsnyang.statement.title': 'Только то, что нужно.',
    'kitsnyang.statement.free': 'Бесплатно',
    'kitsnyang.statement.noAds': 'Без рекламы',
    'kitsnyang.statement.music': 'Несколько треков',
    'kitsnyang.statement.morning': 'Для утра',
    'kitsnyang.showcase.eyebrow': 'Четыре экрана',
    'kitsnyang.showcase.title': 'Четырех экранов достаточно.',
    'kitsnyang.showcase.body': 'Выберите время, цвет, звук и выключите утром.',
    'kitsnyang.showcase.aria': 'Четыре основных экрана Kitsnyang',
    'kitsnyang.screen.list.title': 'Список будильников',
    'kitsnyang.screen.list.body': 'Выделяются только активные будильники.',
    'kitsnyang.screen.time.title': 'Настройка времени',
    'kitsnyang.screen.time.body': 'Колесо легкое и точное.',
    'kitsnyang.screen.sound.title': 'Звуки будильника',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Отключить будильник',
    'kitsnyang.screen.dismiss.action': 'Отключить',
    'kitsnyang.screen.dismiss.body': 'Понятно сразу после пробуждения.',
    'kitsnyang.sounds.eyebrow': 'Звуки',
    'kitsnyang.sounds.title': 'Разное утро под разное настроение.',
    'kitsnyang.sounds.body': 'Послушайте первые треки в том же порядке, что и в приложении.',
    'kitsnyang.sounds.aria': 'Плеер избранных звуков будильника',
    'kitsnyang.player.eyebrow': 'Сейчас предпросмотр',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Мягкое пробуждение',
    'kitsnyang.closing.title': 'Даже пробуждение<br />может быть немного милым.',
    'kitsnyang.closing.body': 'Kitsnyang бесплатный, без рекламы, и позволяет выбрать звуки для утра.',
  },
  tr: {
    'home.meta.description': 'skyepodium projeleri ve servisleri için statik tanıtım sitesi.',
    'home.meta.title': 'skyepodium',
    'home.hero.eyebrow': 'Küçük servisler, net etkileşimler.',
    'home.hero.title': 'Küçük kurar,<br />uzun ömürlü olacak şekilde inceltiriz.',
    'home.hero.lead':
      'Uygulamalar, araçlar ve küçük dijital oyuncaklar tasarlayıp parlatıyorum. Şu anda bir sabah alarmı uygulaması olan <a href="./kitsnyang.html">Kitsnyang</a> üzerinde çalışıyorum.',
    'home.hero.cta': 'Kitsnyang’ı gör',
    'home.actions.aria': 'Öne çıkan çalışmalar',
    'home.project.body': 'Ücretsiz, reklamsız, birden fazla alarm sesi. Sabahı biraz daha kolaylaştıran bir alarm.',
    'home.project.linkAria': 'Kitsnyang sayfasına git',
    'kitsnyang.meta.description':
      'Kitsnyang, birden fazla alarm sesi ve eğlenceli alarm ayar ekranı sunan ücretsiz, reklamsız bir sabah alarmı uygulamasıdır.',
    'kitsnyang.meta.title': 'Kitsnyang - daha nazik bir sabah alarmı',
    'kitsnyang.hero.eyebrow': 'Ücretsiz alarm uygulaması / reklamsız',
    'kitsnyang.hero.line': 'Uyanmayı biraz daha kolaylaştıran bir sabah alarmı.',
    'kitsnyang.proof.aria': 'Kitsnyang temel özellikleri',
    'kitsnyang.proof.free': 'Ücretsiz',
    'kitsnyang.proof.noAds': 'Reklamsız',
    'kitsnyang.proof.sounds': 'Birçok ses',
    'kitsnyang.heroStage.aria': 'Kitsnyang uygulama ekranları önizlemesi',
    'kitsnyang.icon.alt': 'Kitsnyang uygulama ikonu',
    'kitsnyang.phone.list.aria': 'Alarm listesi ekranı örneği',
    'kitsnyang.phone.sound.aria': 'Alarm sesi seçim ekranı örneği',
    'kitsnyang.alarm.daily': 'Her gün',
    'kitsnyang.alarm.weekdays': 'Hafta içi',
    'kitsnyang.alarm.weekend': 'Hafta sonu',
    'kitsnyang.sound.label': 'Alarm sesi',
    'kitsnyang.sound.featured': 'Geoje Sea Breeze',
    'kitsnyang.sound.caption': 'Mavi deniz esintisi',
    'kitsnyang.statement.eyebrow': 'Gürültüsüz',
    'kitsnyang.statement.title': 'Sadece gerekenler.',
    'kitsnyang.statement.free': 'Ücretsiz',
    'kitsnyang.statement.noAds': 'Reklamsız',
    'kitsnyang.statement.music': 'Birden çok parça',
    'kitsnyang.statement.morning': 'Sabah için tasarlandı',
    'kitsnyang.showcase.eyebrow': 'Dört ekran',
    'kitsnyang.showcase.title': 'Dört ekran yeter.',
    'kitsnyang.showcase.body': 'Saati seç, rengi seç, sesi seç ve sabah kapat.',
    'kitsnyang.showcase.aria': 'Kitsnyang’ın dört ana ekranı',
    'kitsnyang.screen.list.title': 'Alarm listesi',
    'kitsnyang.screen.list.body': 'Yalnızca açık alarmlar belirginleşir.',
    'kitsnyang.screen.time.title': 'Saat ayarla',
    'kitsnyang.screen.time.body': 'Tekerlek hafif ve hassas kalır.',
    'kitsnyang.screen.sound.title': 'Alarm sesleri',
    'kitsnyang.sound.geoje': 'Geoje Sea Breeze',
    'kitsnyang.sound.orum': 'Orum Breeze, Rise Up',
    'kitsnyang.sound.today': 'Today Lights Up',
    'kitsnyang.screen.dismiss.title': 'Alarmı kapat',
    'kitsnyang.screen.dismiss.action': 'Kapat',
    'kitsnyang.screen.dismiss.body': 'Uyandığında tek bakışta anlaşılır.',
    'kitsnyang.sounds.eyebrow': 'Alarm sesleri',
    'kitsnyang.sounds.title': 'Her ruh hali için farklı bir sabah.',
    'kitsnyang.sounds.body': 'İlk parçaları uygulamadaki sırayla hemen dinleyin.',
    'kitsnyang.sounds.aria': 'Öne çıkan alarm sesi oynatıcısı',
    'kitsnyang.player.eyebrow': 'Şimdi önizleme',
    'kitsnyang.sound.jeju': 'Jeju Tangerine Tok Tok',
    'kitsnyang.sound.stayBlue': 'Into the Neon Sea',
    'kitsnyang.sound.paradise': 'Paraparadise',
    'kitsnyang.sound.ventanas': 'Bright Sea Windows',
    'kitsnyang.closing.eyebrow': 'Yumuşak uyanış',
    'kitsnyang.closing.title': 'Uyanmak bile<br />biraz sevimli olabilir.',
    'kitsnyang.closing.body': 'Kitsnyang ücretsizdir, reklam içermez ve sabaha uygun sesler seçmenizi sağlar.',
  },
};
...
for (const [language, translations] of Object.entries(SITE_TRANSLATION_OVERRIDES)) {
  TRANSLATIONS[language] = {
    ...TRANSLATIONS.en,
    ...(TRANSLATIONS[language] || {}),
    ...translations,
